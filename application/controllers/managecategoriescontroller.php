...
class manageCategoriesController extends Controller{
	...
	public function update(){
		...
		$name = $_POST['name'];
		$data = array('categoryName'=>$_POST['name'],'categoryID'=>$_POST['categoryID']);
		$this->categoryObject = new Categories;
		$outcome = $this->categoryObject->update($data);
		...
		$outcome = $this->categoryObject->getCategoriesAll();
	...
	public function index(){
		$this->categoryObject = new Categories;
		$categories = $this->categoryObject->getCategoriesAll();
